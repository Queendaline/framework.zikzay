...
class Util2
{
    ...
    public static function currentPage()
    {
        ...
        if ($currentPage == SR || $currentPage == SR . strtolower(DEFAULT_CONTROLLER) . '/index') {
            $currentPage = SR . strtolower(DEFAULT_CONTROLLER);
        }
        return $currentPage;
    }
    ...
    public static function jsonErrorResponse($message = 'Request failed', $data = null)
    {
        $object['status'] = false;
        $object['message'] = $message;
        if ($data != null) $object['causes'] = $data;
        self::jsonResponse($object);
    }

    public static function jsonSuccessResponse($message = 'Request failed', $data = null)
    {
        $object['status'] = true;
        $object['message'] = $message;
    ...
    public static function reference(int $length = 12, $prefix = null, $split = null)
    {
        ...
        $string = ($micro[1] + 369098080) . explode('.', $micro[0])[1];
    ...
    public static function generateId(int $length)
    {
        return self::base64url_encode(self::reference($length));
    }

    public static function decodeId(string $id)
    {
        return self::base64url_decode($id);
    }
