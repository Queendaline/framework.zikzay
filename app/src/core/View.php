...
class View extends Display
{
    ...
    public static function render($view, $data, $sideNav = true, $header = true, $footer = true) {
        ...
        $body = ob_get_clean();
        if($viewPath[0] == 'admin') {
            include VIEWS_PATH . DS .'admin/static/app.php';
        }else {
//            include VIEWS_PATH . DS . 'user/static/app.php';
