...
$live = !(($host == 'localhost' or $host == '127.0.0.1') or $host == null);

if(!isset($_SERVER['HTTP_HOST'])) {
    define('SR',  '');
} else {
    define('SR',  $http.$host.$scriptName);
}
...
QUESTIONS_ASSET_PATH = SR .'/public/assets/questions/',

UPLOAD_PATH = PUBLIC_PATH.'/assets/upload/',

SUMMARY_ASSET_PATH = SR .'/public/assets/subjects/',
...
//require_once VIEWS_PATH .DS.'user'.DS.'widget.php';
